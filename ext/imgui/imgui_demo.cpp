...
// [SECTION] Example App: Manipulating window titles / ShowExampleAppWindowTitles() //klngsley
...
#pragma GCC diagnostic ignored "-Wint-to-pointer-cast"              // warning: cast to pointer from integer of different size  //klngsley
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Option to save .ini data with extra comments (particularly helpful for Docking, but makes saving slower).");  //klngsley
...
static void DemoWindowWidgetsBasic()
{
    if (ImGui::TreeNode("Basic"))
    {
        ...
        // Color buttons, demonstrate using PushID() to add unique identifier in the ID stack, and changing style.  //klngsley
...

        {
            ...
            // This technique can also be used with DragInt(). //klngsley
...
static void DemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Checkbox("Columns", &show_columns);          // Will use contents size  //klngsley
...
static void DemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        {
            // Declare columns
            // We use the "user_id" parameter of TableSetupColumn() to specify a user id that will be stored in the sort specifications.  //klngsley
            // This is so our sort function can identify a column given our own identifier. We could also identify them based on their index!
...
// Note the difference between BeginMainMenuBar() and BeginMenuBar():  //klngsley
